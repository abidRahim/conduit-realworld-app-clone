       ...
       :
        <div>
          <div className="article-header wrapper">
            ...
            <div className="user-meta">
              ...
              <div className="follow-btn-box ">
                <Link to='/signup'><button className="follow-btn flw-btn"><strong>+</strong>Follow <span> {article.author.username} </span></button></Link>
              </div>
              <div className="follow-btn-box">
                <Link to='/signup'><button className="follow-btn fav-btn"><i className="fav fas fa-heart fa-xs"></i>Favourite <span> Article ({article.favoritesCount}) </span></button></Link>
              </div>
            </div>
          </div>
          ...
          <div className="footer-user-meta">
            <p><Link to="/signin" className="link-text">Sign in</Link> or <Link to="/signup" className="link-text">Sign up</Link> to add comments on this article.</p>
          </div>
      </div>      
      }
      {
